...
def _key_words(value: str) -> str:
    ...
    aliases = {
        ...
        "customer programme price": "member price",
        "customer program price": "member price",
        "loyalty offer": "member price",
        "loyalty price": "member price",
        "app price": "member price",
        "appprice": "member price",
        "membership price": "member price",
        "membershipprice": "member price",
        "member price": "member price",
        "memberprice": "member price",
        "plus price": "member price",
        "plusprice": "member price",
        "club price": "member price",
        "clubprice": "member price",
        "nonmember": "non member",
        "nonmember price": "ikke medlem pris",
        "non member price": "ikke medlem pris",
        "regular price": "normal pris",
        "regularprice": "normal pris",
        "normal price": "normal pris",
    }
