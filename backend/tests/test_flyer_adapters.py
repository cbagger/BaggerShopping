...
def test_restores_shared_compound_in_tjek_variants():
    publication = Publication(
        id="netto-week", retailer="Netto", title="Uge 34",
        source_url="https://netto.test", page_count=1,
