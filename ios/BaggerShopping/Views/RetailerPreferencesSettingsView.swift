...
struct RetailerPreferencesSettingsSection: View {
    ...
    var body: some View {
        Section("Aviser og tilbud") {
            ...
            Text("Vælg hvilke butikker denne iPhone skal vise under Aviser, søge i efter nye tilbud og kunne modtage avis-push fra. Allerede gemte tilbud på familiens indkøbsliste påvirkes ikke.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
    ...
    var body: some View {
        List {
            Section {
                ...
                Text("Valget gælder kun denne iPhone. En butik, der slås fra her, skjules fra Aviser, tilbudssøgning og nye automatiske tilbudsforslag og kan ikke sende avis-push. Et tidligere push-valg huskes, hvis butikken senere aktiveres igen. Tilbud, som allerede er knyttet til familiens fælles indkøbsliste, bevares og vises fortsat på alle familiens telefoner.")
            }
